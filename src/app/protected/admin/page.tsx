...
import { 
    ...
    ListChecks, Megaphone, BookUser, BookCopy, CalendarCheck, Building, FileWarning, Award, ShieldCheck, BarChart3, Printer, CalendarOff, PenSquare
} from "lucide-react";
...
const allMenuItems: AdminMenuItem[] = [
    ...
    { title: "Administrasi Ujian", href: "/protected/admin/administrasi-ujian", icon: PenSquare, color: "text-orange-500" },
