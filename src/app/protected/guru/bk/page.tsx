  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground font-headline">Dasbor Bimbingan Konseling</h1>
          <p className="text-muted-foreground">
            Menu dan alat bantu untuk Bimbingan Konseling (BK).
          </p>
        </div>
      </div>
       ...
       <Card>
        <CardHeader>
          <CardTitle>Menu Bimbingan Konseling</CardTitle>
          <CardDescription>
            Akses cepat ke fitur-fitur terkait BK.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
           <Link href="/protected/guru/laporan-kegiatan">
                <Card className="hover:bg-primary/5 hover:border-primary cursor-pointer h-full">
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">Buat dan kelola laporan kegiatan terkait layanan Bimbingan Konseling.</p>
                    </CardContent>
                </Card>
           </Link>
