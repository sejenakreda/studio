  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground font-headline">Dasbor Operator</h1>
          <p className="text-muted-foreground">
            Menu dan alat bantu untuk tugas operator sekolah.
          </p>
        </div>
      </div>
       ...
       <Card>
        <CardHeader>
          <CardTitle>Menu Operator</CardTitle>
          <CardDescription>
            Akses cepat ke fitur-fitur terkait tugas operator.
          </CardDescription>
        </CardHeader>
