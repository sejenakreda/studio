  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
       ...
       <Card>
        <CardHeader>
          <CardTitle>Menu Pembina</CardTitle>
          <CardDescription>
            Akses cepat ke fitur-fitur terkait pembinaan.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
           <Link href="/protected/guru/laporan-kegiatan">
                <Card className="hover:bg-primary/5 hover:border-primary cursor-pointer h-full">
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">Buat dan kelola laporan untuk kegiatan OSIS atau Ekstrakurikuler yang Anda bina.</p>
                    </CardContent>
                </Card>
           </Link>
        </CardContent>
