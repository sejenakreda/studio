  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground font-headline">Dasbor Staf TU</h1>
          <p className="text-muted-foreground">
            Menu dan alat bantu untuk tugas Anda sebagai Staf Tata Usaha.
          </p>
        </div>
      </div>
       ...
       <Card>
        <CardHeader>
          <CardTitle>Menu Staf TU</CardTitle>
          <CardDescription>
            Akses cepat ke fitur-fitur terkait tugas Anda.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
           <Link href="/protected/guru/laporan-kegiatan?context=staf_tu">
